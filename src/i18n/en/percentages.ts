export default {
  ...
  subtitle: 'Find and compare percentages',
  shortDescription:
    'A user-friendly calculator for efficient percentage calculations. Ideal for educational, personal, or professional use, simplifying the way you find and compare percentages.',
  description:
